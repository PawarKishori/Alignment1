...
def WSD_modulo_e_words_h_words():
    try :
        ...
        with open(logfile,"a") as log :
            print(logfile)
            log.write("A_exact_match_WSD_modulo.dat for sentence no. "+sent_no+"doesn't exist "+"\n")
            sys.exit()
...
#E_sentence="/home/nupur/tmp_anu_dir/tmp/ai1E_tmp/2.115/E_sentence"
E_sentence=sys.argv[1]
#H_sentence="/home/nupur/tmp_anu_dir/tmp/ai1E_tmp/2.115/H_sentence"
H_sentence=sys.argv[2]
#wsd_exact_match_file="/home/nupur/tmp_anu_dir/tmp/ai1E_tmp/2.115/A_exact_match_WSD_modulo.dat"
wsd_exact_match_file=sys.argv[3]
temp=E_sentence.split("/")[:-1]
tmp_path="/".join(temp)
sent_no=temp[-1]
logpath="/".join(tmp_path.split("/")[:-1])
logfile=logpath+"/Exact_match_dict_log"
# print(tmp_path)
csvfile=tmp_path+"/Exact_match_dict.csv"

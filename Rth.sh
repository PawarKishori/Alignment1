...
#Preprocessing steps
		...
		echo "creating finite_clauses.dat, english_clauses.dat, Aligned_clauses.dat, Words_Aligned_using_clauses.dat"
		python3 $HOME_alignment/all_clause_facts.py
         	#echo "creating english_clauses.dat"
		#python3 $HOME_alignment/english_clause.py

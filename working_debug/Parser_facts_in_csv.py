...
# sent_no = '2.88' #2.29, 2.21, 2.61, 2.14, 2.64
...
potential_anchor_v2 = extract_row_from_df_as_list_by_column_name_and_cell_value(dfs,'Resources','Potential anchors v2')
starting_anchor_v2 = extract_row_from_df_as_list_by_column_name_and_cell_value(dfs,'Resources','Starting anchor v2')

print(starting_anchor_v2)
print(potential_anchor_v2)

start_v2_dict ={}
for i,val in enumerate(title,0):
    start_v2_dict[i] = starting_anchor_v2[i]
print(start_v2_dict)
#display(dfs)
new
...
#     print(str(item) + " ("+ start_v2_dict[item]+")")
    if start_v2_dict[item]=='0':
        tmp=str(item) 
    else:
        tmp = str(item) + " ("+ start_v2_dict[item]+")"
